...
| [12개월 v4](EDA-final-12m-v4.pdf) **확정판** | 1억 8,922만 행 | **접속 세션에도 하루 리듬.** 목표 지표 10개 전부 달성 · 정합성 17종 · 이상치 9종 위반 0.<br>**정밀 EDA 9개 축 추가(23쪽)** — 인구·계층·경제·퍼널·분포형태. **13장에 "할 수 있는 것 17 / 주의 7 / 할 수 없는 것 14"** 를 갈라 놨다. **이 데이터를 쓰기 전에 13장을 먼저 본다** |
