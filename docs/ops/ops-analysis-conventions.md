...
## 마트에 무엇을 구울까 — 제안, 아직 정해진 것이 아니다

⚠️ 아래는 **정해진 설계가 아니라 제안**이다. 마트 그레인은 P6 에서 정한다.
위 절(표준 필터·실측·갭 3건)까지가 관측된 사실이고, 여기부터는 의견이다.

위 규칙을 쿼리마다 다시 쓰게 두면 언젠가 한 곳이 빠진다. 마트에서 해결하는 편이 낫다.
