...
**P0~P2·P4·P5·P6·W0~W19 완료** → 다음은 **P7 루커 스튜디오**

stg 뷰 10개와 mart 표 8개가 서 있다(2026-08-18). 마트만 연결하면 대시보드가
그려지고, **주간으로 좁혀 전주와 비교하는 것까지 검증됐다**. 절차와 주간 규칙 넷은
[[ops-p5-p7]], 그레인을 그렇게 정한 이유는 [[mart-grain-for-weekly-filter]].
